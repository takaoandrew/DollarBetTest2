...
public class FriendDbAdapter {
    ...
    public FriendDbAdapter open() throws android.database.SQLException {
    ...
    public long updateFriend(long idToUpdate, String newTitle, String newMessage, Friend.Category newCategory) {
        ContentValues values = new ContentValues();
