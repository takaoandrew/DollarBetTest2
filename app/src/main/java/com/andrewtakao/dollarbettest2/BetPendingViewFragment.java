 ...
 */
public class BetPendingViewFragment extends Fragment {


    public BetPendingViewFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View fragmentLayout = inflater.inflate(R.layout.fragment_bet_pending_view, container, false);
